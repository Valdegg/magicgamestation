...
# This will add a cron job that runs daily at 20:00 (8:00 PM), but the wrapper script
...
# Runs daily at 20:00 (8:00 PM) - the wrapper script handles the 2-day logic
CRON_ENTRY="0 20 * * * $CRON_SCRIPT >> $SCRIPT_DIR/market_scan_cron.log 2>&1"
...
echo ""
echo "The market scan will run every 2 days at 20:00 (8:00 PM)"
